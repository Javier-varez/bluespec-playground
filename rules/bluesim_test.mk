...
$(_BLUESIM_TEST): $(LOCAL_SRC_DIR)/$(LOCAL_BSV_TB) $(addprefix $(LOCAL_SRC_DIR)/, $(LOCAL_BSV_SRC)) $(_GEN_BLUESPEC_DIR) $(_GEN_SIMULATION_DIR) $(THIS_FILE)
	...
	@bsc -u -sim -simdir $(GEN_SIMULATION_DIR) -bdir $(GEN_BLUESPEC_DIR) -info-dir $(GEN_BLUESPEC_DIR) -keep-fires -aggressive-conditions -g $(TESTBENCH_MODULE) -p $(SRC_DIR):%/Libraries $<
	@bsc -e $(TESTBENCH_MODULE) -sim -o $@ -simdir $(GEN_SIMULATION_DIR) -bdir $(GEN_BLUESPEC_DIR) -info-dir $(GEN_BLUESPEC_DIR) -keep-fires -aggressive-conditions -g $(TESTBENCH_MODULE) -p $(SRC_DIR):%/Libraries
